...
export type GenericMorph = ComponentBaseContact | ComponentBaseLocation | Discipline | Event | I18NLocale | UploadFile | UploadFolder | UserDiscipline | UserEvent | UserGroup | UserGroupEvent | UserPlayLocation | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type UserEventFiltersInput = {
  ...
  updatedAt?: InputMaybe<DateTimeFilterInput>;
  user?: InputMaybe<UsersPermissionsUserFiltersInput>;
  where?: InputMaybe<UserPlayLocationFiltersInput>;
};
